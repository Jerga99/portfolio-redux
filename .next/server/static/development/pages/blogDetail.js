...
function (_React$Component) {
  ...
  function BlogDetail(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BlogDetail).call(this, props));
    _this.state = {
      content: []
    };
    return _this;
  ...
  _createClass(BlogDetail, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
        var reduxStore, query, req, blog;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                reduxStore = _ref.reduxStore, query = _ref.query, req = _ref.req;
                _context.prev = 1;
                _context.next = 4;
                return _actions__WEBPACK_IMPORTED_MODULE_4__["getBlogBySlug"](req, query.slug);
...
/***/ 4:
/*!***********************************!*\
  !*** multi ./pages/blogDetail.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./pages/blogDetail.js */"./pages/blogDetail.js");
